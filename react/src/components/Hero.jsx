    ...
    return (
        <div className="relative bg-white overflow-hidden">
            ...
            <div className="relative pt-6 pb-16 md:pb-20 lg:pb-24 xl:pb-32">
                <div className="relative mt-8 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
                    {/* Large logo on the right side */}
                    <div className="hidden lg:block absolute right-12 top-0 transform -translate-y-6">
                        <div className="flex items-center justify-center bg-white p-5 rounded-full shadow-lg border-2 border-purple-100">
                            <div className="bg-purple-50 p-8 rounded-full">
                                <FaHandHoldingMedical className="h-40 w-40 text-purple-600" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center mb-8 lg:hidden">
                        <div className="flex items-center justify-center bg-white p-4 rounded-full shadow-lg border-2 border-purple-100">
                            <div className="bg-purple-50 p-6 rounded-full">
                                <FaHandHoldingMedical className="h-16 w-16 text-purple-600" />
                            </div>
                        </div>
                    </div>
                    ...
                    <main>
                        <div className="text-center lg:text-left">
                            ...
                            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl lg:mx-0">
                                ...
                                solutions to improve patient care, streamline
                                operations, and enhance community health
                                monitoring across the Philippines.
                            </p>
