...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="fixed top-0 w-full z-10 bg-white shadow-sm border-b border-gray-100">
                    ...
                    <div className="sm:hidden">
                        <div className="px-2 pt-2 pb-3 space-y-1">
                            ...
                            <div className="mt-4">
                                <Link
                                    to="/login"
                                    className="block w-full text-center px-4 py-2 rounded-md bg-purple-600 text-white text-sm font-medium hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-150 ease-in-out"
                                >
                                    Login
                                </Link>
                            </div>
            ...
            {/* Spacer div to prevent content from shifting up under the fixed navbar */}
            <div className="h-16"></div>
            {/* Add extra height if mobile menu is open */}
            {isOpen && <div className="sm:hidden h-64"></div>}
        </>
    );
}
